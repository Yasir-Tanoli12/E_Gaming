    ...
    <div className={`flex flex-wrap items-center ${gapClass} ${className}`}>
      {contacts.facebook ? (
        <a
          ...
          aria-label="Facebook"
          title="Facebook"
          className={`${base} border-[#AAE847]/50 bg-[#EB523F]/25 text-[#EEEDEE] shadow-[3px_3px_0_#161015] hover:bg-[#EB523F]/40`}
        >
      ...
      {wa ? (
        <a
          ...
          aria-label="WhatsApp"
          title="WhatsApp"
          className={`${base} border-[#161015]/40 bg-[#AAE847]/90 text-[#161015] shadow-[3px_3px_0_#161015] hover:bg-[#AAE847]`}
        >
          <svg viewBox="0 0 24 24" className={`${ic} fill-current`} aria-hidden="true">
      ...
      {ig ? (
        <a
          ...
          title="Instagram"
          className={`${base} border-[#EA3699]/50 bg-gradient-to-br from-[#EA3699]/35 to-[#EB523F]/25 text-[#EEEDEE] shadow-[3px_3px_0_#161015] hover:from-[#EA3699]/50 hover:to-[#EB523F]/35`}
        >
          <svg viewBox="0 0 24 24" className={`${ic} fill-current`} aria-hidden="true">
      ...
      {includeEmailIcon && mail ? (
        <a
          ...
          title="Email"
          className={`${base} border-[#EEEDEE]/35 bg-[#161015]/80 text-[#EEEDEE] shadow-[3px_3px_0_#EB523F] hover:bg-[#161015]`}
        >
          <svg viewBox="0 0 24 24" className={`${ic} fill-current`} aria-hidden="true">
