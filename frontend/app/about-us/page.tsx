  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-clip bg-[#E9DFE5] text-[#161015]">
      <div className="pointer-events-none fixed inset-0 -z-0 overflow-hidden">
        ...
        <div className="absolute right-0 top-32 h-96 w-96 rounded-full bg-[#EA3699]/20 blur-[110px]" />
        <div className="absolute bottom-16 left-1/3 h-72 w-72 rounded-full bg-[#AAE847]/28 blur-[90px]" />
      </div>

      <PublicNavbar />
      <main className="relative z-10 flex min-h-0 w-full min-w-0 flex-1 flex-col lg:flex-row">
        <div className="sw-legal-animate-left order-1 flex w-full flex-col justify-center border-b-[3px] border-[#EB523F]/50 bg-[#EEEDEE]/95 px-[max(1.25rem,env(safe-area-inset-left))] py-12 pe-[max(1.25rem,env(safe-area-inset-right))] shadow-[inset_0_0_0_2px_rgba(234,54,153,0.15)] backdrop-blur-sm lg:order-none lg:w-[40%] lg:max-w-[40%] lg:border-b-0 lg:border-r-[3px] lg:border-[#EA3699]/45 lg:py-16 lg:ps-10 lg:pe-8">
          ...
          {loading ? (
            ...
            <div className="mt-8 max-h-[min(70vh,720px)] overflow-y-auto pr-1 lg:max-h-[calc(100svh-8rem)]">
              <div className="rounded-r-xl border-l-4 border-[#AAE847] bg-[#E9DFE5]/60 py-2 pl-5 shadow-[4px_0_0_rgba(235,82,63,0.15)]">
